...
import { Search, Filter, Mail, Phone, MapPin, MoreVertical, ChevronDown, Heart } from "lucide-react"
        ...
        <div className="relative z-10 flex min-h-screen w-full flex-col items-center justify-center p-4">
          <div className="w-full max-w-7xl">
            ...
            >
              <div className="flex items-center justify-center h-full">
                <div className="text-center">
                  <h1 className="text-2xl font-medium text-[#9577CA] mb-2">City General Hospital</h1>
                  <p className="text-gray-600">General Hospital</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-6 justify-center">
              ...
              >
                <h2 className="text-xl font-bold text-[#9577CA] mb-6">Hospital Information</h2>
                <form className="space-y-4">
                  <div className="flex items-center">
                    <span className="text-gray-600 w-32">Owner Name:</span>
                    {/* <input
                      type="text"
              ...
              >
                ...
                {/* Date Selection */}
                <div className="mb-6">
                  <h3 className="text-sm font-medium text-black mb-3">Select Date</h3>
        ...
        <div className="flex w-full flex-1 flex-col gap-6 lg:flex-row lg:gap-8">
          ...
          <div className="w-full lg:w-1/2">
            <div className="rounded-lg border bg-white p-4 shadow-lg sm:p-6">
              <h2 className="mb-4 text-xl font-bold text-[#9577CA] sm:text-2xl">Add Hospital</h2>
              <form className="space-y-4">
                {/* Hospital Name */}
                ...
                {/* Map Display */}
                <div className="relative h-40 w-full rounded-lg border border-gray-300 overflow-hidden">
                  <iframe
                  ...
                  <div className="absolute inset-0 pointer-events-none">
                    <MapPin className="absolute top-1/2 left-1/2 h-8 w-8 text-red-500 transform -translate-x-1/2 -translate-y-1/2" />
                  </div>
                </div>
                ...
                <div className="flex justify-end">
                  <button
                    type="submit"
                    className="h-8 w-auto px-6 rounded-lg text-white text-sm mt-4"
                ...
                if (selectedHospitalType === "prefer" && filteredHospitals.length === 0) {
                  return (
                    <div key="no-favorites" className="flex flex-col items-center justify-center py-12 text-center">
                      ...
                      <h3 className="text-lg font-medium text-white mb-2">No Favorite Hospitals</h3>
                      {/* <p className="text-sm text-gray-500 px-4">Click the heart icon on any hospital card to add them to your favorites.</p> */}
                    </div>
                  );
                }
