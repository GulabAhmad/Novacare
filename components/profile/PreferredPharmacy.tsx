...
import PharmacyComponent from '../mypharmacy/pharmacyform';

export default function PreferredPharmacy() {
  ...
  const handleViewPharmacy = () => {
    console.log('View button clicked, opening pharmacyform component')
    setShowPharmacyView(true)
  }

  if (showPharmacyView) {
    console.log('Rendering PharmacyComponent')
        ...
        <div className="flex w-full flex-1 flex-col gap-6 lg:flex-row lg:gap-8">
          ...
          <div className="w-full lg:w-1/2">
            <div className="rounded-lg border bg-white p-4 shadow-lg sm:p-6">
              <h2 className="mb-4 text-xl font-bold text-[#9577CA] sm:text-2xl">Add Pharmacy</h2>
                ...
                if (selectedPharmacyType === "prefer" && filteredPharmacies.length === 0) {
                  return (
                    <div key="no-favorites" className="flex flex-col items-center justify-center py-12 text-center">
                      ...
                      <h3 className="text-lg font-medium text-white mb-2">No Favorite Pharmacies</h3>
                      {/* <p className="text-sm text-gray-500 px-4">Click the heart icon on any pharmacy card to add them to your favorites.</p> */}
                    </div>
                  );
                }
                    ...
                    >
                      <div className="flex items-center justify-between mb-3">
                        <div>
                          ...
                          <p className="text-sm text-gray-600">{pharmacy.specialty}</p>
                        </div>
