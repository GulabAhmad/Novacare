...
const DoctorAIResearchAgent: React.FC = () => {
  const router = useRouter();
  const themeConfig = useSelector((state: RootState) => state.themeConfig);

  const handleCallClick = () => {
    router.push('/doctor-ai-research-agent/call');
  };

  const handleChatClick = () => {
    router.push('/doctor-ai-research-agent/chat');
  };
...
export default DoctorAIResearchAgent;
