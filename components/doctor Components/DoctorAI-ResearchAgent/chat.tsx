...
export default function ChatPage() {
  ...
  const handleBack = () => {
    router.push('/doctor-ai-research-agent');
  };
    ...
    <div className="relative min-h-screen w-full bg-cover bg-center">
      ...
      <div className="relative z-10 flex min-h-screen w-full flex-col items-center justify-center p-4 sm:p-6 md:p-8">
        ...
        {/* <div className="absolute bottom-4 right-40">
          <button 
            onClick={handleBack}
            className="px-6 py-3 mr-16 text-white hover:text-gray-700 transition border border-gray-300 rounded-[32px] bg-transparent hover:bg-[#9577CA] hover:text-white font-semibold"
          >
            Back
          </button>
        </div> */}
